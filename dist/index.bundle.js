...
function displayAllTasks() {
  ...
  ___WEBPACK_IMPORTED_MODULE_0__.allTasks.forEach((task) => {
    ;(0,_tasksUI__WEBPACK_IMPORTED_MODULE_1__.addNewTask)(task.name, task.details, task.dueDate)
    console.log(task)
  })
}
...
function addNewTask(taskName, taskDetails, taskDate) {
...
function createNewTask() {
  ...
  const newTask = new _Task__WEBPACK_IMPORTED_MODULE_4__.Task(inputName, inputDetails, inputDate)
  _index__WEBPACK_IMPORTED_MODULE_5__.allTasks.push(newTask)
  addNewTask(newTask.name, newTask.details, newTask.dueDate)
  hideTaskForm()
  console.log(_index__WEBPACK_IMPORTED_MODULE_5__.allTasks)
}
...
module.exports = __webpack_require__.p + "4a705f01cb66e7af66c7.png";
